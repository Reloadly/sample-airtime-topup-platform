        ...
        handleComplete: function(){
            ...
            if(this.intInput.isValidNumber()) {
                ...
                if (this.send == "0") {
                    ...
                    if (this.selectedOperator.denomination_type === 'RANGE') {
                        if (this.isLocalTransfer) {
                            if (this.localAmount < this.selectedOperator.local_min_amount || this.localAmount > this.selectedOperator.local_max_amount) {
                                toastr.error('Amount much be within range');
                                this.isLoading = false;
                                return;
                            }
                        } else {
                            if (this.amount < this.selectedOperator.min_amount || this.amount > this.selectedOperator.max_amount) {
                                toastr.error('Amount much be within range');
                                this.isLoading = false;
                                return;
                            }
