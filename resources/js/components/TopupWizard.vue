            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form-wizard color="#7367F0" errorColor="#f0666d" title="Topup Sender" subtitle="Advanced Wizard To Send Topup Globally." finishButtonText="Proceed to Payment" @on-error="handleErrorMessage" @on-complete="handleComplete">
                            <tab-content title="Select Country" icon="feather icon-globe" >
                                <div class="row justify-content-center align-items-center py-3">
                                    <label class="col-auto" for="country">Country</label>
                                    <div class="col-md-6">
                                        <select class="custom-select form-control required" id="country" name="country" v-model="selectedCountry" required>
                                            <option v-for="country in countries" :value="country">{{ country.name }}</option>
                                        </select>
                                    </div>
                                </div>
                            </tab-content>
                            <tab-content title="Enter Number" icon="feather icon-codepen" :before-change="ValidateNumber">
                                <div class="tab-content pt-1">
                                    <div  id="sn_number" role="tabpanel" aria-labelledby="home-tab-fill">
                                        <div class="row justify-content-center py-3 align-items-center">
                                            <label class="col-auto" for="number">Enter Number</label>
                                            <input id="number" class="col-md-4 form-control required" type="number" name="number" value="" v-model="selectedNumber">
                                        </div>
                                    </div>
                                </div>
                            </tab-content>
                            <tab-content title="Confirm Operator" icon="feather icon-compass">
                                <div class="row justify-content-center align-items-center py-3">
                                    <label class="col-auto" for="operator">Operator</label>
                                    <div class="col-md-6">
                                        <select class="custom-select form-control required" id="operator" name="operator" v-model="selectedOperator">
                                            <option v-for="operator in operators" :value="operator">{{ operator.name }}</option>
                                        </select>
                                    </div>
                                </div>
                            </tab-content>
                            <tab-content title="Topup Amount" icon="feather icon-voicemail">
                                <ul class="nav nav-tabs nav-fill" role="tablist" v-if="selectedOperator.supports_local_amounts">
                                    <li class="nav-item">
                                ...
                                <div class="tab-content pt-1">
                                    <div v-bind:class="[isLocalTransfer?'':'active']" class="tab-pane" id="international_transfers" role="tabpanel" aria-labelledby="home-tab-fill">
                                        ...
                                        <div class="pb-3" v-bind:class="[selectedOperator.denomination_type === 'RANGE'?'d-none':'']">
                                            <div class="row justify-content-center align-items-center">
                                                <label class="col-auto" for="select_amount">Amount</label>
                                                <div class="col-md-6">
                                        ...
                                        <div class="row justify-content-center align-items-center pb-3" v-bind:class="[selectedOperator.denomination_type === 'RANGE'?'':'d-none']">
                                            <label class="col-auto" for="text_amount">Amount <b>Min : {{ selectedOperator.min_amount }} Max : {{ selectedOperator.max_amount }}</b></label>
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <select class="custom-select form-control">
                                    ...
                                    <div v-bind:class="[isLocalTransfer?'active':'']" class="tab-pane" id="local_transfers" role="tabpanel" aria-labelledby="home-tab-fill" v-if="selectedOperator.supports_local_amounts">
                                        <div class="py-3" v-bind:class="[selectedOperator.denomination_type === 'RANGE'?'d-none':'']">
                                            <div class="row justify-content-center align-items-center">
                                                <label class="col-auto" for="select_amount">Amount</label>
                                                <div class="col-md-6">
                                        ...
                                        <div class="row justify-content-center align-items-center pb-3" v-bind:class="[selectedOperator.denomination_type === 'RANGE'?'':'d-none']">
                                            <label class="col-auto" for="text_amount">Amount <b>Min : {{ selectedOperator.local_min_amount }} Max : {{ selectedOperator.local_max_amount }}</b></label>
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
...
export default {
    data() {
        return {
            ...
            selectedCountry : {"id":1,"iso":"AF","name":"Afghanistan","currency_code":"AFN","currency_name":"Afghan Afghani","currency_symbol":"\u060b","flag":"https:\/\/s3.amazonaws.com\/rld-flags\/af.svg"},
            selectedNumber : null,
            selectedFile : null,
            isLoading: false,
    ...
    methods: {
        ...
        ValidateCountry: function () {
            return new Promise((resolve, reject) => {
                if (this.selectedCountry){
                    axios.get("/countries/" + this.selectedCountry.id + "/numbers").then(response => {
        ...
        ValidateNumber: function () {
            return new Promise((resolve, reject) => {
                ...
                axios.get("/api/countries/" + this.selectedCountry.id + "/operators/detect/" + this.selectedNumber).then(response => {
                    if (response.data) {
