...
install:
	...
	@docker-compose up -d
	@docker exec -it $(DOCKER_PROJECT_CODE)_php cp .env.example .env
	@docker exec -it $(DOCKER_PROJECT_CODE)_php composer install -vvv
	@docker exec -it $(DOCKER_PROJECT_CODE)_php php artisan migrate
	@docker exec -it $(DOCKER_PROJECT_CODE)_php php artisan db:seed
	@docker exec -it $(DOCKER_PROJECT_CODE)_php php artisan sync:countries
	@docker-compose down
	@make -s start
update:
	$(info $(pink)------------------------------------------------------)
